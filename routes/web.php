...
use App\Http\Controllers\ClusteringExportController;
use App\Http\Controllers\DatasetController;
use App\Http\Controllers\DokumenController;
use App\Http\Controllers\Export\ClusteringExportController as ExportClusteringExportController;
use App\Http\Controllers\ExportHasilClusteringController;
...
|
*/
Route::get('/dataset', [DatasetController::class, 'index'])->middleware('auth');
Route::get('/proses-clustering', [ClusteringController::class, 'index'])->middleware('auth');
Route::get('/riwayat-clustering', [RiwayatClusteringController::class, 'index'])->middleware('auth');
Route::get('/analisis', [AnalisisPetaRisikoController::class, 'index'])->middleware('auth');
